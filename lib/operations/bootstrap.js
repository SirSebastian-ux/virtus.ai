...
export async function bootstrapWorkspace({
  ...
  if (!existingRoleAssignment) {
    ...
    const existingEmployeeId =
      existingRoleAssignment.employee_id || null;

    if (!existingEmployeeId && ownerEmployeeId) {
      const { error: roleLinkError } = await admin
        .from("operations_role_assignments")
        .update({
          employee_id: ownerEmployeeId,
    ...
    ownerEmployeeId = existingEmployeeId || ownerEmployeeId;
  }

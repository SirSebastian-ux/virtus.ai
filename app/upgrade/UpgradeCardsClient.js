        ...
        <section className={cardClass}>
          <div className="flex-1">
            ...
            <div className="mt-4 rounded-2xl border border-sky-900/25 bg-black/25 px-4 py-3">
              <p className="text-2xl font-semibold text-sky-50">$0 <span className="text-sm font-normal text-zinc-400">/ free account</span></p>
      ...
      {isGuestSelection || currentPlan === "free" || currentPlan === "plus" ? (
        <section className={cardClass}>
          <div className="flex-1">
            ...
            <div className="mt-4 rounded-2xl border border-sky-900/25 bg-black/25 px-4 py-3">
              <p className="text-2xl font-semibold text-sky-50">$19 <span className="text-sm font-normal text-zinc-400">/ month</span></p>
              <p className="mt-1 text-xs leading-5 text-sky-300/70">
                Yearly plan: $15.99 / month when billed yearly
              </p>
            </div>
        ...
        <section className={premiumCardClass}>
          <div className="flex-1">
            ...
            <div className="mt-4 rounded-2xl border border-sky-500/30 bg-black/25 px-4 py-3 shadow-sm shadow-sky-950/20">
              <p className="text-2xl font-semibold text-sky-50">$49 <span className="text-sm font-normal text-zinc-400">/ month</span></p>
              <p className="mt-1 text-xs leading-5 text-sky-300/80">
                Yearly plan: $44.99 / month when billed yearly
              </p>
            </div>
          ...
          {isGuestSelection ? (
            ...
            >
              {currentPlan === "premium"
                ...
                : loadingPlan === "premium"
                ? "Opening checkout..."
                : "Upgrade to Premium / Virtus Prime"}
            </button>
          ) : null}
        </section>
      ) : null}
